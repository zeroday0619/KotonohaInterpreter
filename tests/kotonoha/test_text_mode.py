...
def test_mixed_script_reports_a_partial_share() -> None:
...
def test_weak_script_share_inherits() -> None:
...
def test_unusable_setting_falls_back_to_the_first_allowed_language() -> None:
    decision = decide_typed_language("Hello", "de", None, ALLOWED)
    assert decision.language == "ko" and decision.source == "inherited"


# -- state machine ----------------------------------------------------------
def test_typed_turn_goes_straight_from_idle_to_processing() -> None:
...
def test_speaking_is_still_unreachable_from_idle() -> None:
    machine = Machine()
    with pytest.raises(IllegalTransition):
        machine.to(State.SPEAKING, "skip")


def test_metrics_record_the_input_mode() -> None:
    m = TurnMetrics()
...
async def test_input_bar_is_hidden_until_text_mode(
    _positional_only: object | None = None,
    /,
    *,
    interpreter: Any,
...
async def test_the_t_key_enters_text_mode(
    _positional_only: object | None = None,
    /,
    *,
    interpreter: Any,
...
async def test_escape_leaves_text_mode_from_the_focused_field(
    _positional_only: object | None = None,
    /,
    *,
    interpreter: Any,
...
async def test_typing_t_into_the_field_does_not_leave_text_mode(
    _positional_only: object | None = None,
    /,
    *,
    interpreter: Any,
...
async def test_leaving_text_mode_restores_the_previous_voice_mode(
    _positional_only: object | None = None,
    /,
    *,
    interpreter: Any,
...
async def test_mode_key_cycles_through_all_three(
    _positional_only: object | None = None,
    /,
    *,
    interpreter: Any,
...
async def test_text_mode_closes_the_microphone(
    _positional_only: object | None = None,
    /,
    *,
    interpreter: Any,
...
async def test_blank_submission_is_ignored(
    _positional_only: object | None = None,
    /,
    *,
    interpreter: Any,
...
async def test_placeholder_follows_the_locale(
    _positional_only: object | None = None,
    /,
    *,
    interpreter: Any,
