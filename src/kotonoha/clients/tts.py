...
from kotonoha.config import TextToSpeechConfig
from kotonoha.transport import Encoding, decode_pcm
...
class TextToSpeechClient(BaseClient):
    ...
    async def synthesize(self, text: str, language: str) -> AsyncIterator[np.ndarray]:
        payload = {
            "text": text,
            "lang": language,
